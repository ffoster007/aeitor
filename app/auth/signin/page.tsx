...
// Google brand SVG (no lucide equivalent — kept as minimal inline)
const GoogleIcon = () => (
        ...
        <div className="w-full max-w-sm">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="px-5 pb-5 flex flex-col gap-3">
              ...
              <button
                type="submit"
                className="mt-1 w-full py-2.5 rounded-xl text-sm text-white hover:opacity-80 transition-opacity flex items-center justify-center gap-2"
          ...
          <p className="text-center text-xs mt-6" style={{ color: "#aaa", fontFamily: "'Helvetica Neue', sans-serif", lineHeight: "1.6" }}>
            ...
            <span className="underline underline-offset-2 cursor-pointer hover:text-neutral-600 transition-colors">Terms of Service</span>{" "}
            and{" "}
            <span className="underline underline-offset-2 cursor-pointer hover:text-neutral-600 transition-colors">Privacy Policy</span>.
          </p>
        </div>
      </section>
    </main>
