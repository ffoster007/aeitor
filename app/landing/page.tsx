...
const PRICING_PLANS = [
	{
		...
		price: "$0",
		cadence: "/month",
		description: "A lightweight starting point for teams replacing spreadsheets with a shared renewal calendar.",
		highlight: "Best for evaluation",
		features: [
			"Track up to 10 active vendor contracts",
			"30-day renewal reminders",
			"Single workspace with 2 team members",
			"Basic spend and renewal overview",
		],
		cta: "Start free",
		emphasized: false,
	},
	{
		...
		price: "$10",
		cadence: "/user /month",
		description: "Built for finance and operations teams that need earlier alerts, clearer ownership, and better reporting.",
		highlight: "Most popular",
		features: [
			"Unlimited contracts and vendors",
			"90, 60, and 30-day automated alerts",
			"Owner assignments and activity history",
			"CSV export and renewal pipeline reporting",
		],
		cta: "Get started",
		emphasized: true,
	},
	{
		...
		price: "$20",
		cadence: "/user /month",
		description: "For multi-team organizations that need stronger controls, vendor visibility, and executive reporting.",
		highlight: "For larger teams",
		features: [
			"Everything in Growth",
			"Advanced approval flows",
			"Priority support and onboarding help",
			"Quarterly spend and risk review exports",
		],
		cta: "Get started",
		emphasized: false,
	},
